...
function FooterCol({ title, links }: { title: string; links: { label: string; href: string }[] }) {
  return (
    <div>
      <div style={{ fontFamily: "var(--font-display)", fontSize: 11, fontWeight: 700, letterSpacing: "0.1em", color: "#4fc3f7", textTransform: "uppercase", marginBottom: 14 }}>{title}</div>
  ...
  return (
    <div style={{ background: "#0f1923", color: "#8a9bb0", marginTop: 60, borderTop: "1px solid #1e2d3d" }}>
      ...
      <div style={{ borderTop: "1px solid #1a2634", padding: "16px", maxWidth: 900, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 8 }}>
        ...
        <span style={{ color: "#4a5a6a", fontSize: 12 }}>Data by <a href="https://www.api-football.com" style={{ color: "#4fc3f7", textDecoration: "none" }}>API-Football</a> · Updates every 60s</span>
      </div>
    </div>
  );
}
